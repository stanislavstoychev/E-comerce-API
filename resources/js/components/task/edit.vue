                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="login-form">
                                    ...
                                    <form class="user" @submit.prevent="taskUpdate" enctype="multipart/form-data">
...
export default {
    ...
    methods: {
        ...
        taskUpdate() {
            ...
            //paramethers with files attached

            let fd = new FormData();
            fd.append('img', this.file);
            fd.append('subcontractor_id', this.form.subcontractor_id);
            ...
            fd.append('substructure_id', this.form.substructure_id);
            fd.append('description', this.form.description);
            fd.append('actual_start', this.form.actual_start);
            fd.append('actual_finish', this.form.actual_finish);
            fd.append('planned_start', this.form.planned_start);
            fd.append('planned_finish', this.form.planned_finish);
            fd.append('priority', this.form.priority);
            fd.append('schedule_id', this.form.schedule_id);
            fd.append('percent_complete', this.form.percent_complete);
            ...
            let id = this.$route.params.id;
            axios.post(`/api/task/${id}`, fd, contentType)
                .then((data) => {
                    this.$router.push({
                        name: "task",
                    })
