                                    ...
                                    <form class="user" @submit.prevent="customerUpdate" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" id="exampleInputFirstName"
                                                        placeholder="Enter Customer Name" v-model="form.name">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="email" class="form-control" id="exampleInputFirstName"
                                                        placeholder="Enter Customer Email" v-model="form.email">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" id="exampleInputFirstName"
                                                        placeholder="Enter Customer Phone" v-model="form.phone">
