                            ...
                            <div class="col-lg-12">
                                <div class="login-form">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Update Step</h1>
                                    </div>
                                    <form class="user" @submit.prevent="stepUpdate" enctype="multipart/form-data">
...
export default {
    ...
    methods: {
        ...
        stepUpdate() {
            ...
            axios.post('/api/stepidedit/' + id, fd)
                .then(() => {
                    this.$router.push({
                        name: "step"
                    })
